...
<head class="h-full bg-gray-100">
    ...
    <!-- Include Tailwind CSS through Vite -->
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="/home"
                                   class="rounded-md px-3 py-2 text-sm font-medium {{ request()->is('home') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}" aria-current="page">Home</a>
                                <a href="/about"
